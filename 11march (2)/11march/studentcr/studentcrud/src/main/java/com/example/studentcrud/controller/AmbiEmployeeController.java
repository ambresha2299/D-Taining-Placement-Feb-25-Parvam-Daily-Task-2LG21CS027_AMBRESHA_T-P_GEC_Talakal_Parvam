...
import com.example.studentcrud.service.AmbiEmployeeService;

@Controller
@RequestMapping("/ambi")

public class AmbiEmployeeController {

    @Autowired
    private AmbiEmployeeService employeeService;
